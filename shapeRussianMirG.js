class shapeRussianMirG extends Shape
{
    constructor(startX, startY, blockSize, color = "green")
    {
        ...
        var block = new Block(this.blocks[0].x, this.blocks[0].y - blockSize, blockSize, this.color, 0 * blockSize, 0 * blockSize);
        ...
        block = new Block(this.blocks[2].x - blockSize, this.blocks[2].y, blockSize, this.color, 2 * blockSize, 0 * blockSize);    
